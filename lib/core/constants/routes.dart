...
Map<String, Widget Function(BuildContext)> routes = {
  ...
  '/flowerColor1': (context) => PaintScreen(
        uncoloredImage: AppImages.uncoloredflower1fram,
        coloredImage: AppImages.coloredflower1fram,
        categoryName: "Flowers",
        colorTools: AppColors.flower1Colors,
        itemKey: 'flower1',
      ),
  '/flowerColor2': (context) => PaintScreen(
        uncoloredImage: AppImages.uncoloredflower2fram,
        coloredImage: AppImages.coloredflower2fram,
        categoryName: "Flowers", 
        colorTools: AppColors.flower2Colors,
        itemKey: 'flower2',
      ),
  '/flowerColor3': (context) => PaintScreen(
        uncoloredImage: AppImages.uncoloredflower3fram,
        coloredImage: AppImages.coloredflower3fram,
        categoryName: "Flowers",
        colorTools: AppColors.flower3Colors,
        itemKey: 'flower3',
      ),
  '/flowerColor4': (context) => PaintScreen(
        uncoloredImage: AppImages.uncoloredflower4fram,
        coloredImage: AppImages.coloredflower4fram,
        categoryName: "Flowers",
